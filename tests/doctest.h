...
// - push_back/pop_back
// - assign/insert/erase
// - relational operators as clear functions - taking const char* as one of the params
...
int Context::run() {
    ...
    auto cleanup_and_return = [&]() {
        ...
        // we have to clear the reporters which were allocated when the run started
